...
// MLCM.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMLCMApp, CWinApp)
...
// Единственный объект CMLCMApp

CMLCMApp theApp;


// инициализация CMLCMApp

BOOL CMLCMApp::InitInstance()
{
